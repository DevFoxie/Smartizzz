<?php
  ...
  {
    if(@$_GET['demail'] && $_SESSION['key']=='devfoxie') 
    {
      $demail=@$_GET['demail'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='devfoxie') 
    {
      $eid=@$_GET['eid'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='devfoxie') 
    {
      $name = $_POST['name'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addqns' && $_SESSION['key']=='devfoxie') 
    {
      $n=@$_GET['n'];
      $eid=@$_GET['eid'];
      $ch=@$_GET['ch'];
